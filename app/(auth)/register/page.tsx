  ...
  return (
    <div className="bg-white rounded-[40px] p-8 xl:p-16 shadow-2xl flex flex-col items-center">
      ...
      <h1 className="text-3xl xl:text-4xl font-bold text-center text-zinc-900 mb-10 leading-tight">
        Let's get you started with<br />Eztrackr
      </h1>
      ...
      <form onSubmit={onSubmit} className="w-full space-y-6">
        <div>
          <label className="block text-sm font-medium text-zinc-500 mb-2 ml-1">Name</label>
          <input 
            name="name" 
        ...
        >
          {registerMutation.isPending ? "Setting up..." : registerMutation.isSuccess ? "Welcome!" : "Register"}
        </button>
      ...
      <div className="mt-10 text-center space-y-4">
        <p className="text-sm text-zinc-500">
          Already have an account? <Link href="/login" className="font-bold text-zinc-900 hover:text-[#7C3AED]">Login</Link>
        </p>
